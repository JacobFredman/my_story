...
const PrivatePolicy = () => {
    return (
        <div>
            <p>
                <h1>תנאי שימוש באתר "הסטורי שלי"</h1>
                <h3>תקנון השימוש באתר הנ"ל נכתב בלשון זכר אך האמור בו מתייחס לנשים וגברים כאחד.</h3>
                <p></p>
                <ol>
                    <li>
                        <h4>קדימון</h4>
                        <p>אתר "הסטורי שלי" (להלן "האתר") הוא אתר המשתמש כאתר ("שיווק, מכירה וליווי של ערכת הסטורי שלי – התפתחות אישית בעולם דיגיטלי") ייצוגי עבור "הסטורי שלי" והנך מוזמן לקחת בו חלק בכפוף להסכמתך לתנאי השימוש אשר יפורטו להלן</p>
                    ...
                    <li>
                        <h4>קניין רוחני</h4>
                        <p>האתר כמו גם כל המידע שבו לרבות עיצוב האתר, קוד האתר, קבצי מדיה לרבות גרפיקות, סרטונים, תמונות, טקסטים, קבצים המוצעים להורדה וכל חומר אחר אשר מוצג באתר שייכים במלואם לאתר הנ"ל ומהווים קניין רוחני בלעדי של אתר "הסטורי שלי" ואין לעשות בהם שימוש ללא אישור כתוב מראש מאתר "הסטורי שלי".</p>
                    ...
                    <li>
                        ...
                        <p>התכנים המוצעים באתר הינם בבעלותם הבלעדית של "הסטורי שלי" ואין לעשות בהם שימוש אשר נועד את האמור בתקנון זה (ראה סעיף 3) למעט במקרים בהם צוין אחרת או במקרים בהם צוין כי זכויות היוצרים שייכים לגוף חיצוני. במקרים אלו יש לבדוק מהם תנאי השימוש בקישור המצורף ולפעול על פי המצוין באתר החיצוני לו שייכים התכנים.</p>
                    </li>
                    <li>
