        ...
        <React.Fragment>
            ...
            <Row>
                <Col >
                    ...
                    <div className="circle1" style={{ backgroundColor: `${props.color}` }}>{props.percent + '%'}</div>
                    <div className="progress1">
                        {/* <div className="progress-bar1" style={{ width: '40%', backgroundColor: '#8B008B' }}> */}
                        <div className="progress-bar1" style={{ width: props.percent + '%', backgroundColor: `${props.color}` }}>
                        </div>
                    </div>
                </Col>
                {/* <Col></Col> */}
